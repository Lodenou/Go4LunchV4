...
public class AddUserFavoriteToDatabaseTest {
    ...
    @Test
    public void addUserFavoriteToDatabase_Success() {
        // Act
        detailRepository.removeUserFavoriteFromDatabase();

        // Assert
        Map<String, Object> expectedData = new HashMap<>();
        expectedData.put("favoritesRestaurant", ""); // Assuming the removal sets the favoriteRestaurant to an empty string
